"""
Django settings for ravisintera project.
"""
...
ALLOWED_HOSTS = ['my.ravisintera.ch','ravisintera.juntagrico.science', 'localhost',]
...
ROOT_URLCONF = 'ravisintera.urls'

DATABASES = {
    'default': {
        'ENGINE': os.environ.get('JUNTAGRICO_DATABASE_ENGINE','django.db.backends.sqlite3'), 
        'NAME': os.environ.get('JUNTAGRICO_DATABASE_NAME','ravisintera.db'), 
...
WSGI_APPLICATION = 'ravisintera.wsgi.application'
